...
import UserInterface.Manufacturer.DrugManagerJPanel;
...
public class DrugManagerRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business) {
        return new DrugManagerJPanel(userProcessContainer, enterprise, account,business); //To change body of generated methods, choose Tools | Templates.
    }
